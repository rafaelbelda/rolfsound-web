...
_DEFAULTS = {
    ...
    # Tipo de conta: "standard" (produto) ou "admin" (interno).
    # Discovery (busca/download do YouTube via yt-dlp) só existe para admin —
    # o gate é aplicado NO SERVIDOR (403), nunca só na UI.
